...
import com.bean.pay.alipay.httpClient.HttpProtocolHandler;
import com.bean.pay.alipay.httpClient.HttpRequest;
import com.bean.pay.alipay.httpClient.HttpResponse;
import com.bean.pay.alipay.httpClient.HttpResultType;
...
public class AlipaySubmit {
	...
	public static String buildRequestMysign(Map<String, String> sPara) {
    	String content = AlipayCore.createLinkString(sPara); //把数组所有元素，按照“参数=参数值”的模式用“&”字符拼接成字符串
//        String mysign = "";
//        if(AlipayConfig.sign_type.equals(AlipayConfig.SIGN_MD5)) {
//        	mysign = MD5.sign(prestr, AlipayConfig.key, AlipayConfig.input_charset);
//        }else if(AlipayConfig.sign_type.equals(AlipayConfig.SIGN_RSA)){
//        	mysign = RSA.sign(prestr, AlipayConfig.key, AlipayConfig.input_charset);
//        }
        return AlipayConfig.sign(content);
    }

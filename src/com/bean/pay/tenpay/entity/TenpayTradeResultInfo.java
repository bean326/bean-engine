 ...
 *         2016年4月5日
 */
public class TenpayTradeResultInfo extends TenpayFromWeChatBaseInfo implements Serializable {


    private static final long serialVersionUID = 6277861779214398739L;
     ...
     * @return
     */
    public final static TenpayTradeResultInfo parseFromXML(String resultXML) {
        TenpayTradeResultInfo tradeResult = null;
        try {
            Map map = XMLUtil.doXMLParse(resultXML);

            tradeResult = BeanMapUtils.toBean(TenpayTradeResultInfo.class, map);
